...
const translations = {
  en: {
    ...
    automator: {
      ...
      navigate: "Navigate",
      newTab: "New Tab",
      newTabUrlHint: "Leave empty to open a blank tab, or enter a full URL.",
      newTabUrlPlaceholder: "e.g. https://www.google.com (empty = about:blank)",
      switchTab: "Switch Tab",
      waitForSelector: "Wait For Selector",
      waitForURL: "Wait For URL",
      fill: "Fill",
      assert: "Assert",
      keyRecordPressHint: "Press keys...",
      keyRecordClickHint: "Click to record",
      navWaitLoad: "Wait: Page Loaded",
      navWaitDomContentLoaded: "Wait: DOM Ready",
      navWaitNetworkIdle: "Wait: Network Idle",
      tabStrategyLastOpened: "Last Opened Tab",
      tabStrategyIndex: "Tab Index",
      tabIndexHint: "Index starts from 1 (1->tab1, 2->tab2; 9+ maps to last tab).",
      tabStrategyUrlContains: "URL Contains",
      tabStrategyTitleContains: "Title Contains",
      tabMatchPlaceholder: "Enter URL/title keyword...",
      waitStateAttached: "State: Attached",
      waitStateVisible: "State: Visible",
      waitStateHidden: "State: Hidden",
      urlMatchValuePlaceholder: "Enter URL match value...",
      urlModeContains: "Mode: Contains",
      urlModeEquals: "Mode: Equals",
      urlModeRegex: "Mode: Regex",
      fillClearBefore: "Clear before filling",
      assertKindSelectorExists: "Selector Exists",
      assertKindTextContains: "Text Contains",
      assertKindUrlContains: "URL Contains",
      assertKindUrlEquals: "URL Equals",
      assertKindUrlRegex: "URL Regex",
      expectedValuePlaceholder: "Expected value...",
      selectorCandidateCount: "Fallback selectors: {{count}}",
      pickWebElement: "Pick Web Element",
      pickingWebElement: "Click target element in browser...",
      pickWebSelectorFailed: "Failed to pick web element. Make sure Chrome/Edge runs with --remote-debugging-port=9222.",
      // Node Labels
    ...
    context: {
      ...
      scanCapped: "Scan reached entry limit ({{scanned}}/{{max}}). Narrow filters or increase max entries.",
      filterDirs: "Folders",
      filterFiles: "Files",
      filterExts: "Exts",
    ...
    patch: {
      title: "Git Insights",
      selectRepository: "Select a repository to inspect",
      repositoryIdle: "Browse branches first, then drill into commits, files, and diffs without losing context.",
      noCommitMessage: "No commit message available.",
      loadingRepository: "Refreshing repository...",
      historyTab: "History",
      branchesTab: "Branches",
      compareTab: "Compare",
      branchExplorer: "Branch Explorer",
      branchManagerTitle: "Branch Management",
      ...
      selectedBranchHint: "Select a branch to inspect its status and latest commit.",
      upstream: "Upstream",
      ...
      checkoutFailed: "Failed to switch branch: {{msg}}",
      ...
      loadingMoreCommits: "Loading more commits...",
      scrollForMore: "Scroll to load more history",
      historyFullyLoaded: "All visible history loaded",
      commitPlaceholder: "Select a commit from the graph to inspect its metadata and changed files.",
      compareTitle: "Git Compare",
      compareFallbackTitle: "Compare revisions",
      compareHint: "Keep the original compare flow, but anchor it to the selected branch context.",
      workingTree: "Working Tree",
      baseVersion: "Base Revision",
      compareVersion: "Target Revision",
      initialCommit: "Initial Commit",
      comparing: "Loading diff...",
      generateDiff: "Run Compare",
      changes: "Changes",
      filesLabel: "files",
      diffableFiles: "Diffable",
      noFilesInSelection: "No changed files in the current selection.",
      selectFile: "Select a file from the sidebar to inspect the diff.",
      exportBlocked: "Binary and oversized files cannot be exported.",
      export: "Export",
      exportSuccess: "Changes exported successfully.",
      selectOne: "Select at least one diffable file.",
      noDiff: "No differences found for the current selection.",
      binaryFile: "Binary",
      largeFile: "Large",
      staged: "Staged",
      unstaged: "Unstaged",
      ...
      noChangedFiles: "No file changes were reported for this commit.",
      selectionSummary: "Selection Summary",
      totalChanges: "Total Changes",
      binaryBlocked: "Binary Files",
      largeBlocked: "Large Files",
      fileDetails: "File Details",
      path: "Path",
      previousPath: "Previous Path",
      statusLabel: "Status",
      commitSelectPlaceholder: "Select a commit...",
      commitSearchPlaceholder: "Search by message, hash, or author...",
      copied: "Copied!"
    },
    editor: {
      titleNew: "New Prompt",
    ...
    settings: {
      title: "Settings",
      pageHint: "Centralized app preferences and maintenance",
      groupCore: "Core",
      groupContent: "Content",
      groupTrust: "Trust",
      navGeneral: "General",
      navSearchWorkspace: "Search & Workspace",
      navDataMaintenance: "Data & Maintenance",
      ...
      automatorShortcutTip: "Recommended: Alt+F1, Ctrl+Shift+A",
    ...
    spotlight: {
      ...
      dropToUpload: "Drop files or images to upload",
      attachmentTooMany: "Too many files. Max {{max}} attachments.",
      attachmentTotalSizeExceeded: "Total attachment size exceeded.",
      attachmentImageTooLarge: "Image \"{{name}}\" is too large.",
      attachmentFileTooLarge: "File \"{{name}}\" is too large.",
      attachmentUnsupportedType: "Unsupported file type: {{name}}",
      attachmentParseFailed: "Failed to parse file: {{name}}",
    ...
    workspace: {
      ...
      emptyRecent: "No recent workspaces yet.",
      selectHint: "Select a workspace from the title bar to start.",
      loadHint: "Click refresh to load the current workspace.",
      sharedHint: "Shared by Context, Git, Miner, and command execution.",
    ...
    common: {
      ...
      lockedDirNotScanned: "Children are hidden because this directory is locked.",
  ...
  zh: {
    ...
    automator: {
      ...
      navigate: "页面跳转",
      newTab: "新建标签页",
      newTabUrlHint: "留空会打开空白标签页，也可以直接填写完整 URL。",
      newTabUrlPlaceholder: "例如：https://www.google.com（留空 = about:blank）",
      switchTab: "切换标签页",
      waitForSelector: "等待元素",
      waitForURL: "等待 URL",
      fill: "填充输入框",
      assert: "断言检查",
      keyRecordPressHint: "按下组合键...",
      keyRecordClickHint: "点击开始录制",
      navWaitLoad: "等待：页面加载完成",
      navWaitDomContentLoaded: "等待：DOM 就绪",
      navWaitNetworkIdle: "等待：网络空闲",
      tabStrategyLastOpened: "最后打开的标签页",
      tabStrategyIndex: "按标签页序号",
      tabIndexHint: "序号从 1 开始（1=第1个，2=第2个；9及以上会切到最后一个）。",
      tabStrategyUrlContains: "按 URL 包含",
      tabStrategyTitleContains: "按标题包含",
      tabMatchPlaceholder: "输入 URL/标题关键词...",
      waitStateAttached: "状态：已附加（存在于 DOM）",
      waitStateVisible: "状态：可见",
      waitStateHidden: "状态：隐藏",
      urlMatchValuePlaceholder: "输入 URL 匹配值...",
      urlModeContains: "模式：包含",
      urlModeEquals: "模式：完全匹配",
      urlModeRegex: "模式：正则匹配",
      fillClearBefore: "填充前先清空",
      assertKindSelectorExists: "断言：元素存在",
      assertKindTextContains: "断言：文本包含",
      assertKindUrlContains: "断言：URL 包含",
      assertKindUrlEquals: "断言：URL 完全匹配",
      assertKindUrlRegex: "断言：URL 正则匹配",
      expectedValuePlaceholder: "输入期望值...",
      selectorCandidateCount: "候选定位: {{count}}",
      pickWebElement: "拾取 Web 元素",
      pickingWebElement: "请在浏览器中点击目标元素...",
      pickWebSelectorFailed: "Web 元素拾取失败，请确保 Chrome/Edge 已开启 --remote-debugging-port=9222。",
      // Node Labels
    ...
    context: {
      ...
      scanCapped: "扫描达到条目上限 ({{scanned}}/{{max}})，请收紧过滤规则或提高上限。",
      filterDirs: "文件夹",
      filterFiles: "文件",
      filterExts: "后缀",
    ...
    patch: {
      title: "版本洞察",
      selectRepository: "先选择一个仓库再开始查看",
      repositoryIdle: "先看清分支，再继续下钻提交、文件和差异，保持完整上下文。",
      noCommitMessage: "没有可显示的提交信息。",
      loadingRepository: "正在刷新仓库...",
      historyTab: "历史",
      branchesTab: "分支",
      compareTab: "对比",
      branchExplorer: "分支浏览",
      branchManagerTitle: "分支管理",
      currentBranch: "当前分支",
      ...
      current: "当前",
      branchDetails: "分支详情",
      selectedBranchHint: "选择一个分支后，再查看它的状态和最近一次提交。",
      upstream: "上游分支",
      noUpstream: "没有上游",
      syncStatus: "同步状态",
      synced: "已同步",
      ...
      switchBranch: "切换",
      trackBranch: "跟踪",
      checkoutSuccess: "已切换到 {{branch}}。",
      checkoutFailed: "切换分支失败：{{msg}}",
      branchHistory: "分支历史",
      openHistory: "查看历史",
      graphLabel: "图谱",
      commitCount: "提交数",
      ...
      changesColumn: "变更",
      loadingMoreCommits: "正在加载更多提交...",
      scrollForMore: "继续下滑以加载更多历史",
      historyFullyLoaded: "当前历史已全部加载",
      commitPlaceholder: "从提交树中选择一个提交后，再查看它的元数据和变更文件。",
      compareTitle: "Git 对比",
      compareFallbackTitle: "版本对比",
      compareHint: "保留原有 Git 对比流程，但让它始终依附于当前分支上下文。",
      workingTree: "工作区",
      baseVersion: "基准版本",
      compareVersion: "目标版本",
      initialCommit: "初始提交",
      ...
      filesLabel: "文件",
      diffableFiles: "可对比",
      noFilesInSelection: "当前选择下没有变更文件。",
      selectFile: "从左侧选择文件以查看差异。",
      exportBlocked: "二进制文件和超大文件不支持导出。",
      export: "导出",
      exportSuccess: "变更导出成功。",
      selectOne: "请至少选择一个可导出的文件。",
      noDiff: "当前选择下没有发现差异。",
      binaryFile: "二进制",
      largeFile: "大文件",
      staged: "已暂存",
      ...
      commitSearchPlaceholder: "按消息、哈希或作者搜索...",
      copied: "已复制！"
    },
    editor: {
      titleNew: "新建指令",
    ...
    settings: {
      title: "设置",
      pageHint: "统一管理应用偏好与维护项",
      groupCore: "核心",
      groupContent: "内容",
      groupTrust: "安全",
      navGeneral: "通用",
      navSearchWorkspace: "搜索与工作区",
      navDataMaintenance: "数据与维护",
      navAppearance: "外观设置",
      navLanguage: "语言选项",
      navFilters: "全局过滤",
      navLibrary: "指令商店",
      ...
      automatorShortcutTip: "推荐: Alt+F1, Ctrl+Shift+A",
    ...
    spotlight: {
      ...
      dropToUpload: "拖拽文件或图片到这里上传",
      attachmentTooMany: "附件过多，最多 {{max}} 个。",
      attachmentTotalSizeExceeded: "附件总大小超出限制。",
      attachmentImageTooLarge: "图片 \"{{name}}\" 过大。",
      attachmentFileTooLarge: "文件 \"{{name}}\" 过大。",
      attachmentUnsupportedType: "不支持的文件类型：{{name}}",
      attachmentParseFailed: "解析文件失败：{{name}}",
    ...
    workspace: {
      ...
      clear: "清空工作区",
      recent: "最近工作区",
      emptyRecent: "还没有最近工作区记录。",
      selectHint: "请先在顶部标题栏选择工作区。",
      loadHint: "点击刷新后再载入当前工作区。",
    ...
    common: {
      ...
      lockedDirNotScanned: "该目录已锁定，子项不再扫描与展示。",
